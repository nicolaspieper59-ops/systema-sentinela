...
def main():
    ...
    terre = eph['earth']
    station_base = wgs84.latlon(lat_target, lon_target, elevation_m=alt_target) # Correction structurelle station
    ...
    payload = {
        ...
        "METEO_DEFAUT": {"tempC": 15.0, "presHpa": 1013.25}, # Pris en charge par le pipeline anti-adblock
